...
insert into instance(id, name, description, image_id, flavour_id, hostname, state, current_cpu, current_memory, created_at, updated_at,namespace)
values (1, "instance 1", "A test instance", 1, 1, "instance1.host.eu", "ACTIVE", 0, 0, '2019-01-01', '2019-01-01','panosc');
insert into instance(id, name, description, image_id, flavour_id, hostname, state, current_cpu, current_memory, created_at, updated_at,namespace)
values (2, "instance 2", "Another test instance", 2, 2, "instance2.host.eu", "BUILDING", 0, 0, '2019-01-01', '2019-01-01','panosc');
