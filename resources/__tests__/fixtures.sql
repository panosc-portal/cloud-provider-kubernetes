...
insert into instance_account(id, user_id, username, uid, gid, home_path, email, instance_id)
values (1, 123, "bloggs", 1000, 2000, "/home/bloggs", "joe@bloggs", 1);
insert into instance_account(id, user_id, username, uid, gid, home_path, email, instance_id)
values (2, 321, "doe", 1001, 2000, "/home/doe", "jane@doe", 2);
insert into instance_account(id, user_id, username, uid, gid, home_path, email, instance_id)
values (3, 456, "parker", 1002, 2000, "/home/parker", "peter@parker", 3);
insert into instance_account(id, user_id, username, uid, gid, home_path, email, instance_id)
values (4, 678, "bloggs", 1000, 2000, "/home/bloggs", "joe@bloggs", 4);
insert into instance_account(id, user_id, username, uid, gid, home_path, email, instance_id)
values (5, 321, "doe", 1001, 2000, "/home/doe", "jane@doe", 5);
insert into instance_account(id, user_id, username, uid, gid, home_path, email, instance_id)
values (6, 321, "doe", 1005, 2000, "/home/doe", "jane@doe", 6);
insert into instance_account(id, user_id, username, uid, gid, home_path, email, instance_id)
values (7, 321, "doe", 1005, 2000, "/home/doe", "jane@doe", 7);
