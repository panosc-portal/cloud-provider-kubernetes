...
export function getTestApplicationContext(): TestApplicationContext {
  ...
  const k8sRequestFactoryService = new K8sRequestFactoryService();
  ...
  const k8sInstanceService = new K8sInstanceService(k8sDeploymentManagerService, k8sServiceManagerService, k8sRequestFactoryService);
